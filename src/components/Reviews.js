...
const Review = (props) => (
  <div className="row mbl">
    ...
    <div className="small-10 small-offset-1 columns">{props.data.name}</div>

    <div className="small-1 columns"><strong>Score:</strong></div>
    <div className="small-10 small-offset-1 columns">{props.data.rating / 100 * 5} stars</div>

    <div className="small-1 columns"><strong>Review:</strong></div>
    <div className="small-10 small-offset-1 columns">{props.data.content}</div>
  </div>
)
